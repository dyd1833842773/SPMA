...
if __name__ == "__main__":
    train_file = r'H:\PyCharm 2023.1.4\pycharm1\Subgraph_sample_and_static\WN18RR\train.txt'  
    test_file = r'H:\PyCharm 2023.1.4\pycharm1\Subgraph_sample_and_static\WN18RR\test.txt'    
    valid_file = r'H:\PyCharm 2023.1.4\pycharm1\Subgraph_sample_and_static\WN18RR\valid.txt' 

    '''test_file_zero = r'FB15k237-owe-data\test_zero.txt'    
    valid_file_zero = r'FB15k237-owe-data\valid_zero.txt' '''

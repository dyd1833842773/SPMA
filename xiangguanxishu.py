...
# 读取 Excel 文件
data = pd.read_excel('./15k237-data/eccel/complex/sampling_results_60_1.xlsx')
...
# 输出结果
print("第七列特征和倒数第二列标签的皮尔森相关系数:", pearson_corr)
print("皮尔森相关系数的 p 值:", pearson_p_value)
print("第七列特征和倒数第二列标签的斯皮尔曼相关系数:", spearman_corr)
